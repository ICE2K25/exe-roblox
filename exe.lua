...
eventEditor = (function()
	...
	local main = create({
		...
		{23,"TextButton",{BackgroundColor3=Color3.new(0.58823531866074,058823531866074,0.59215688705444),BackgroundTransparency=1,BorderSizePixel=0,Font=3,Name="On",Parent={22},Position=UDim2.new(0,2,0,2),Size=UDim2.new(0,16,0,16),Text="",TextColor3=Color3.new(0,0,0),TextSize=14,ZIndex=10,}},
